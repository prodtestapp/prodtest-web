      ...
      <div class='px-4 py-5 bg-white space-y-6 sm:p-6'>
        <div class='grid grid-cols-3 gap-6'>
          <div class='col-span-3 sm:col-span-2'>
            ...
            <input id='password' v-model='password' type='password' name='password' autocomplete='given-name'
                   class='mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md' />

            <label for='password-confirmation' class='block text-sm font-medium text-gray-700'>
              {{ $t('Password Again') }}
            </label>
            <input id='password-confirmation' v-model='password_confirmation' type='password' name='password-confirmation'
